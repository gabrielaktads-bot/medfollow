    ...
    <div className="space-y-4">
      ...
      {notificacoes.length === 0 ? (
        <div className="rounded-lg border bg-card p-12 text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground/70">Alertas aparecerão aqui automaticamente.</p>
        </div>
      ) : (
            ...
            <TableBody>
              {notificacoes.map((n) => (
                ...
                >
                  ...
                  <TableCell><Badge variant="secondary">{n.tipo || "Geral"}</Badge></TableCell>
